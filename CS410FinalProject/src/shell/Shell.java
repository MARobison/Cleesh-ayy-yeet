...
public class Shell {
	...
	public static class Settings {
		...
		public Settings createWithAddedAuxHandlers(
				MultiMap<String, Object> addAuxHandlers) {
			MultiMap<String, Object> allAuxHandlers = new ArrayHashMultiMap<String, Object>(
					auxHandlers);
	 ...
	 * ShellFactory.
	 *
	 * @see com.budhash.cliche.ShellFactory
	 *
	 * @param s
	 *            Settings object for the shell instance
	 * @param commandTable
	 *            CommandTable to store commands
	 * @param path
	 *            Shell's location: list of path elements.
	 */
	 ...
	 *
	 * @see com.budhash.cliche.ShellDependent
	 * @see com.budhash.cliche.ShellManageable
	 *
	 * @param handler
	 *            Object which should be registered as handler.
	 * @param prefix
	 *            Prefix that should be prepended to all handler's command
	 *            names.
	 */
	 ...
	 * subshells.
	 *
	 * @see com.budhash.cliche.Shell#addMainHandler(java.lang.Object, java.lang.String)
	 *
	 * @param handler
	 *            Object which should be registered as handler.
	 * @param prefix
	...
	private void addDeclaredMethods(Object handler, String prefix)
	...
	// Shell is self-manageable, isn't it?
	 ...
	 *             when can't readLine() from input.
	 */
	 ...
	 *
	 * @see com.budhash.cliche.Output
	 *
	 * @param line
	 *            Full command line
	 * @throws com.budhash.cliche.CLIException
	 ...
	 *
	 * @param displayTime
	 *            true if do display, false otherwise
	 */
